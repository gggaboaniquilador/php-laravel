			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="container">
					...
					<div>
						...
						<?php 
							$tags=json_decode($articulos[0]["p_claves_articulo"]);
							 ?>
					...
					<form method="post" enctype="multipart/form-data">
						...
						<label for="fotoOpinion" class="d-none d-md-block col-md-4 col-lg-3">
								...
								<img src="<?php echo $blog["servidor"];?>vistas/img/subirFoto.png" class="img-fluid mt-md-3 mt-xl-2 s prevFotoOpinion">
						...
						if ($enviarOpinion=="ok") {
							echo '<script>
								notie.alert({
									type:1,
									text:"la opinion ha sido enviada correctamente",
									time:5,
									})
							</script>';
						}
						...
						if ($enviarOpinion=="error-formato") {
							echo '<script>
								notie.alert({
									type:3,
									text:"Error en el formato de la imagen, debe ser PNG o JPG",
									time:5,
									})
							</script>';
						}
