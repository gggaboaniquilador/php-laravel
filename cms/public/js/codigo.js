...
$(".summernote-editar-anuncio").summernote({
...
function upload_editar_anuncio(file){
	...
	$.ajax({
		...
		success: function (respuesta) {
			...
			$('.summernote-editar-anuncio').summernote("insertImage", respuesta, function ($image) {
			  $image.attr('class', 'img-fluid');
			});
